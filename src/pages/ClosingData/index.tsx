...
const FormClosing: React.FC = () => {
  ...
  const [sondingData, setSondingData] = useState<
    { id: string; station: string; cm: number; listers: number }[]
  >([]);
  ...
  const [showClosingSondingError, setShowClosingSondingError] =
    ...
    const getcardDash = () => {
      try {
        ...
        if (cachedData) {
          ...
          const flowMeterEndData = cardDash.find(
  ...
  const handleHmEndChange = (e: CustomEvent) => {
    ...
    if (hmEndInput < previousHmEnd) {
      setErrorMessage(
        `Nilai  Hm/Km Akhir tidak boleh lebih kecil dari sebelumnya: ${previousHmEnd}.`
      );
          ...
          <div style={{ marginTop: "30px" }}>
            <IonGrid>
              <IonRow>
                ...
                <IonCol>
                  ...
                  <IonInput
                    ...
                    className={`custom-input ${
                      showClosingSondingError ? "input-error" : ""
                ...
                <IonCol>
                  ...
                  <IonInput
                    ...
                    // disabled
                    onIonChange={(e) =>
                      setClosingDip(e.detail.value as unknown as number)
                    }
                  />
                </IonCol>
              </IonRow>
              ...
              <IonTitle style={{ color: "red", fontSize: "12px" }}>
                * Angka closing dip otomatis tampil sesuai rumus kalibrasi
                sonding untuk FS/FT yang belum di kalibrasi, silahkan masukan
                secara manual
              </IonTitle>
